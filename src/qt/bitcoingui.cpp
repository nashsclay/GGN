                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GlobalGreen Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GlobalGreen address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and globalgreen: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GlobalGreen Core"), this);
    aboutAction->setStatusTip(tr("Show information about GlobalGreen Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GlobalGreen"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GlobalGreen addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GlobalGreen addresses"));
    ...
    openAction->setStatusTip(tr("Open a GlobalGreen: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GlobalGreen Core help message to get a list with possible GlobalGreen command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GlobalGreen Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GlobalGreen network", "", count));
}
...
{
    QString strTitle = tr("GlobalGreen Core"); // default title
...
/** Creates context menu, its actions, and globalgreens up all the relevant signals for mouse events. */
