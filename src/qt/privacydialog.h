...
public:
    ...
    void setZGlobalGreenControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzGGN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzGGN_clicked();
    void on_pushButtonZGlobalGreenControl_clicked();
