...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GlobalGreen Core"),
     ...
     * override -datadir in the globalgreen.conf file in the default data directory
     * (to be consistent with globalgreend behavior)
     */
    if (dataDir != getDefaultDataDirectory())
