...
public:
    explicit AmountSpinBox(QWidget* parent) : QAbstractSpinBox(parent),
                                              currentUnit(BitcoinUnits::GLOBALGREEN),
    ...
    QSize minimumSizeHint() const
    {
        if (cachedMinimumSizeHint.isEmpty()) {
            ...
            int w = fm.width(BitcoinUnits::format(BitcoinUnits::GLOBALGREEN, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
