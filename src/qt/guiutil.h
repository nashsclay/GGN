...
/** Utility functions used by the GlobalGreen Qt UI.
 */
namespace GUIUtil
{
...
// Render GlobalGreen addresses in monospace font
...
// Parse "globalgreen:" URI into recipient object, return true on successful parsing
