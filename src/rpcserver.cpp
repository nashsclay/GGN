...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop GlobalGreen server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "GlobalGreen server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GlobalGreen features */
        {"globalgreen", "masternode", &masternode, true, true, false},
        {"globalgreen", "listmasternodes", &listmasternodes, true, true, false},
        {"globalgreen", "getmasternodecount", &getmasternodecount, true, true, false},
        {"globalgreen", "masternodeconnect", &masternodeconnect, true, true, false},
        {"globalgreen", "masternodecurrent", &masternodecurrent, true, true, false},
        {"globalgreen", "masternodedebug", &masternodedebug, true, true, false},
        {"globalgreen", "startmasternode", &startmasternode, true, true, false},
        {"globalgreen", "createmasternodekey", &createmasternodekey, true, true, false},
        {"globalgreen", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"globalgreen", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"globalgreen", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"globalgreen", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"globalgreen", "getmasternodescores", &getmasternodescores, true, true, false},
        {"globalgreen", "mnbudget", &mnbudget, true, true, false},
        {"globalgreen", "preparebudget", &preparebudget, true, true, false},
        {"globalgreen", "submitbudget", &submitbudget, true, true, false},
        {"globalgreen", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"globalgreen", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"globalgreen", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"globalgreen", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"globalgreen", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"globalgreen", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"globalgreen", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"globalgreen", "checkbudgets", &checkbudgets, true, true, false},
        {"globalgreen", "mnsync", &mnsync, true, true, false},
        {"globalgreen", "spork", &spork, true, true, false},
        {"globalgreen", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"globalgreen", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use globalgreend, or the -server option to globalgreen-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> globalgreen-cli " + methodname + " " + args + "\n";
}
