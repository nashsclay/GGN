...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1553843680, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04829629b29e33a9ccbe2ee9e49251c9d392f77e72a1882c049f904bcc23e92f97c3442d394a1b57e1d323420d798c04f5b559a4353bbff6117086f1392d2a4eee");
        nDefaultPort = 21432;
        ...
        const char* pszTimestamp = "Green is the prime color of the world, and that from which its loveliness arises - GlobalGreen";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04aa241c7bcb77ccf8e71485736ff7c1a7ddf77c1505cfa05273d8bedf6a190e5778e4527f33b09fd6f6b40e57768fa28fc404123013feb90af27bd81c1b30f820") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1553843680;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 335740;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000e4d2d5026c4d7fe0d59fa34f9dbb5fafa13f7bd2e9ae5d0bf800bec3116"));
        assert(genesis.hashMerkleRoot == uint256("0x8948f6aca35a185c3379e36397c04250cf2acfc4e2c3b64a53473b7cd32913eb"));

	vSeeds.push_back(CDNSSeedData("45.77.181.139", "45.77.181.139"));
        vSeeds.push_back(CDNSSeedData("209.250.251.68", "209.250.251.68"));
        vSeeds.push_back(CDNSSeedData("45.32.148.78", "45.32.148.78"));
	...
	strSporkKey = "042CB61D2D82D1AC233FCF5737496A4DFDE34D070688999C283610FF109F0E2C97A9C7A2BFBAF4E03671284D116196D67DDFFA32F1013660F4A800A6A6320F9FF7";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // GlobalGreen: 1 day
        nTargetSpacing = 1 * 60;  // GlobalGreen: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet globalgreen addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet globalgreen script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet globalgreen BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet globalgreen BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet globalgreen BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // GlobalGreen: 1 day
        nTargetSpacing = 1 * 60;        // GlobalGreen: 1 minutes
