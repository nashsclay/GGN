Contributing to GlobalGreen Core
============================

The GlobalGreen Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GlobalGreen Core project, and is not to be
confused with overall GlobalGreen Network Protocol consensus changes.

Whether a pull request is merged into GlobalGreen Core rests with the project merge
...
Patches that change GlobalGreen consensus rules are considerably more involved than
...
Where a patch set proposes to change the GlobalGreen consensus, it must have been
...
The project leader is the release manager for each GlobalGreen Core release.
